...
Public Class FacilityBasicPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.FacilityBasicPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacilityBasicPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacilityBasicPrint = New FacilityBasicPrint
        rpt.Site = Me.Site
        Return rpt
    End Function
