...
Public Class DepositDataQA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.DepositDataQA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDepositDataQA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DepositDataQA = New DepositDataQA()
        rpt.Site = Me.Site
        Return rpt
    End Function
