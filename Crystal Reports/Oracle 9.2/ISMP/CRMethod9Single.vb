...
Public Class CRMethod9Single
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.CRMethod9Single.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_OpacityTestDuration() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRMethod9Single
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRMethod9Single = New CRMethod9Single
        rpt.Site = Me.Site
        Return rpt
    End Function
