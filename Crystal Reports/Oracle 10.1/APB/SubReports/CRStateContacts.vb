...
Public Class CRStateContacts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.CRStateContacts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRStateContacts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRStateContacts = New CRStateContacts
        rpt.Site = Me.Site
        Return rpt
    End Function
