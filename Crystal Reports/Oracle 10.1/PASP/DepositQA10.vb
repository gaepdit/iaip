...
Public Class DepositQA10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.DepositQA10.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DepositNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDepositQA10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DepositQA10 = New DepositQA10
        rpt.Site = Me.Site
        Return rpt
    End Function
