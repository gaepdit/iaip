...
#Region "Document upload messages"
    ...
    Private Function GetDocumentMessageList() As Specialized.ListDictionary
        ...
        messageList.Add(DocumentMessageType.UploadSuccess, "Success: The file ""{0}""" & vbNewLine & "has been uploaded.")
        messageList.Add(DocumentMessageType.UploadFailure, "Error: There was an error uploading the file. " & vbNewLine & "Please try again.")
        messageList.Add(DocumentMessageType.FileTooLarge, "The selected file is too large. " & vbNewLine & "Maximum file size is " & Math.Round(Document.MaxFileSize / (1024 ^ 3), 2) & "GB.")
        messageList.Add(DocumentMessageType.FileEmpty, "The selected file is empty.")
        messageList.Add(DocumentMessageType.DeleteFailure, "Error: The selected file was not deleted. " & vbNewLine & "Please try again.")
        ...
        messageList.Add(DocumentMessageType.DownloadFailure, "Error: There was an error saving the file. " & vbNewLine & "Please try again.")
        messageList.Add(DocumentMessageType.UpdateFailure, "Error: The selected file was not updated. " & vbNewLine & "Please try again.")
