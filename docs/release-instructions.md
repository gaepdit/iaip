...
3. [Update the changelog](../iaip-website/README.md) by editing the `iaip-website\www\changelog\index.md` file.
...
7. Tag the released commit on the `main` branch using a tag in the format `v8/8.x.x`, substituting in the new version number. 
