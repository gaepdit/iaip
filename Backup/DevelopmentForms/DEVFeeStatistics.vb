...
Public Class DEVFeeStatistics
    ...
    Private Sub HelpToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HelpToolStripMenuItem.Click
        Try
            Help.ShowHelp(Label102, "http://airpermit.dnr.state.ga.us/helpdocs/IAIP_help/")
        Catch ex As Exception
        End Try
        ...
        Try
            Select Case cboStatPayType.Text
                Case "ALL"
                    ...
                    "and " & connNameSpace & ".FS_FeeAuditedData.Active = '1' "
                Case "ANNUAL"
                    SQL = "select  " & _
                    "substr(" & connNameSpace & ".APBFacilityInformation.strAIRSNumber, 5) as AIRSNumber,  " & _
                    "strFacilityName, strPaymentPlan,  " & _
...
"and AIRBranch.FSUnderPaid.strAIRSNumber = AIRbranch.APBFacilityInformation.strAIRSNumber "
    ...
    Private Sub llbDetailFeeUniverse_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles llbDetailFeeUniverse.LinkClicked
        Try
            ...
            "AIRBranch.APBFacilityInformation.strFacilityName, strIAIPDesc,   " & _
            ...
            dgvFeeStats.Columns("STRCONTACTFIRSTNAME").DisplayIndex = 3
            dgvFeeStats.Columns("STRCONTACTLASTNAME").HeaderText = "Contact Last Name"
            dgvFeeStats.Columns("STRCONTACTLASTNAME").DisplayIndex = 4
            dgvFeeStats.Columns("STRContactCOMPANYNAME").HeaderText = "Contact Company"
            dgvFeeStats.Columns("STRContactCOMPANYNAME").DisplayIndex = 5
            dgvFeeStats.Columns("STRCONTACTADDRESS").HeaderText = "Address"
            dgvFeeStats.Columns("STRCONTACTADDRESS").DisplayIndex = 6
            dgvFeeStats.Columns("STRCONTACTCITY").HeaderText = "City"
            dgvFeeStats.Columns("STRCONTACTCITY").DisplayIndex = 7
            dgvFeeStats.Columns("STRCONTACTSTATE").HeaderText = "State"
            dgvFeeStats.Columns("STRCONTACTSTATE").DisplayIndex = 8
            dgvFeeStats.Columns("STRCONTACTZIPCODE").HeaderText = "Zip"
            dgvFeeStats.Columns("STRCONTACTZIPCODE").DisplayIndex = 9
            dgvFeeStats.Columns("STRFACILITYSTREET1").HeaderText = "Contact First Name"
            dgvFeeStats.Columns("STRFACILITYSTREET1").DisplayIndex = 10
            dgvFeeStats.Columns("STRFACILITYCITY").HeaderText = "Contact Last Name"
            dgvFeeStats.Columns("STRFACILITYCITY").DisplayIndex = 11
            dgvFeeStats.Columns("STRFACILITYZIPCODE").HeaderText = "Contact Company"
            dgvFeeStats.Columns("STRFACILITYZIPCODE").DisplayIndex = 12
            dgvFeeStats.Columns("STRCONTACTEMAIL").HeaderText = "Contact Email"
            dgvFeeStats.Columns("STRCONTACTEMAIL").DisplayIndex = 13
            dgvFeeStats.Columns("STRCONTACTPhoneNumber").HeaderText = "Contact Phone Number"
            dgvFeeStats.Columns("STRCONTACTPhoneNumber").DisplayIndex = 14
            dgvFeeStats.Columns("datShutDown").HeaderText = "Date Shut Down"
            dgvFeeStats.Columns("datShutDown").DisplayIndex = 15
    ...
    Private Sub llbDetailNotReported_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles llbDetailNotReported.LinkClicked
        Try
            ...
            dgvFeeStats.Columns("STRFIRSTNAME").HeaderText = "Mailout First Name"
            dgvFeeStats.Columns("STRFIRSTNAME").DisplayIndex = 3
            dgvFeeStats.Columns("STRLASTNAME").HeaderText = "Mailout Last Name"
            dgvFeeStats.Columns("STRLASTNAME").DisplayIndex = 4
            dgvFeeStats.Columns("STRContactCONAME").HeaderText = "Mailout Company"
            dgvFeeStats.Columns("STRContactCONAME").DisplayIndex = 5
            dgvFeeStats.Columns("STRCONTACTADDRESS1").HeaderText = "Mailout Address"
            dgvFeeStats.Columns("STRCONTACTADDRESS1").DisplayIndex = 6
            dgvFeeStats.Columns("STRCONTACTCITY").HeaderText = "Mailout City"
            dgvFeeStats.Columns("STRCONTACTCITY").DisplayIndex = 7
            dgvFeeStats.Columns("STRCONTACTSTATE").HeaderText = "Mailout State"
            dgvFeeStats.Columns("STRCONTACTSTATE").DisplayIndex = 8
            dgvFeeStats.Columns("STRCONTACTZIPCODE").HeaderText = "Mailout Zip"
            dgvFeeStats.Columns("STRCONTACTZIPCODE").DisplayIndex = 9
            ...
            'dgvFeeStats.Columns("STRCONTACTPhoneNumber").DisplayIndex = 14
            dgvFeeStats.Columns("datShutDown").HeaderText = "Date Shut Down"
            dgvFeeStats.Columns("datShutDown").DisplayIndex = 13
            dgvFeeStats.Columns("datShutDown").DefaultCellStyle.Format = "dd-MMM-yyyy"
            dgvFeeStats.Columns("strClass").HeaderText = "Classification"
            dgvFeeStats.Columns("strClass").DisplayIndex = 14
            dgvFeeStats.Columns("Operating").HeaderText = "Operating"
            dgvFeeStats.Columns("Operating").DisplayIndex = 15
            dgvFeeStats.Columns("Part70").HeaderText = "Part 70"
            dgvFeeStats.Columns("Part70").DisplayIndex = 16
            dgvFeeStats.Columns("NSPS").HeaderText = "NSPS"
            dgvFeeStats.Columns("NSPS").DisplayIndex = 17

            dgvFeeStats.Columns("numTotalFee").HeaderText = "Total Fees"
            dgvFeeStats.Columns("numTotalFee").DisplayIndex = 18
            dgvFeeStats.Columns("numTotalFee").DefaultCellStyle.Format = "c"
            dgvFeeStats.Columns("TotalPaid").HeaderText = "Total Paid"
            dgvFeeStats.Columns("TotalPaid").DisplayIndex = 19
            dgvFeeStats.Columns("TotalPaid").DefaultCellStyle.Format = "c"
    ...
    Private Sub llbDetailInProgress_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles llbDetailInProgress.LinkClicked
        Try
         ...
         "and strEnrolled = '1'  " & _
            ...
            dgvFeeStats.Columns("STRContactCOmpanyNAME").HeaderText = "Contact Company"
            dgvFeeStats.Columns("STRContactCOmpanyNAME").DisplayIndex = 5
            dgvFeeStats.Columns("STRCONTACTADDRESs").HeaderText = "Contact Address"
            dgvFeeStats.Columns("STRCONTACTADDRESS").DisplayIndex = 6
            dgvFeeStats.Columns("STRCONTACTCITY").HeaderText = "Contact City"
            dgvFeeStats.Columns("STRCONTACTCITY").DisplayIndex = 7
            dgvFeeStats.Columns("STRCONTACTSTATE").HeaderText = "Contact State"
            dgvFeeStats.Columns("STRCONTACTSTATE").DisplayIndex = 8
            dgvFeeStats.Columns("STRCONTACTZIPCODE").HeaderText = "Contact Zip"
            dgvFeeStats.Columns("STRCONTACTZIPCODE").DisplayIndex = 9
            dgvFeeStats.Columns("STRFACILITYSTREET1").HeaderText = "Facility Street"
            dgvFeeStats.Columns("STRFACILITYSTREET1").DisplayIndex = 10
            dgvFeeStats.Columns("STRFACILITYCITY").HeaderText = "Facility City"
