...
#Region "Page Load subs"
    ...
    Sub LoadComboBoxes()
        ...
        Try
            ...
            cboComplianceUnits.Items.Add("Chemicals/Mineral")
...
#Region "Subs and Functions"
    ...
    Sub SaveUnitAssignments()
        ...
        Try
            ...
            '        'SQL = "Update " & connNameSpace & ".SSCPFacilityAssignment set " & _
            '        '"strSSCPUnit = (select strUnit from " & connNameSpace & ".APBUnits where strUnitDesc = '" & cboSSCPUnit.Text & "'), " & _
            '        '"strSSCPAssigningManager = '" & UserGCode & "', " & _
            ...
            '        '"values " & _
            '        '"('0413" & strObject.ToString & "', " & _
            '        '"(select strUnit from " & connNameSpace & ".APBUnits " & _
    ...
    Sub LoadCMSUniverse()
        ...
        Try
           ...
           CMSStatus
            ...
            '"strDistrictName   " & _
            '"from " & connNameSpace & ".APBFacilityInformation, " & connNameSpace & ".APBSupplamentalData,   " & _
            ...
            '"where " & connNameSpace & ".APBFacilityInformation.strAIRSNumber = " & connNameSpace & ".APBSupplamentalData.strAIRSNumber   " & _
            ...
            '"and " & connNameSpace & ".LookUPDistricts.strDistrictCode = " & connNameSpace & ".LookUpDistrictInformation.strDistrictCode  " & SQLLine
            ''"and StrCMSMember = 'A' "
            ...
            For Each strObject In clbEngineers.CheckedItems
                ...
                For Each row In drEngineers
                  ...
                  "and strDelete is Null "
                    ...
                    Statement = Statement & "For the staff member: " & StaffName & vbCrLf & _
                    vbTab & DateText & vbCrLf & vbCrLf & "I. Event(s):" & vbCrLf & _
                    vbTab & vbTab & vbTab & "Started" & vbTab & vbTab & "Closed" & vbTab & vbTab & "Currently Open" & _
                    vbCrLf & "Report(s)" & vbTab & vbTab & vbTab & StartedReports & vbTab & vbTab & ClosedReports & vbTab & vbTab & OpenReports & _
                    ...
                    vbCrLf & "Performance Test(s)" & vbTab & vbTab & StartedISMPTests & vbTab & vbTab & ClosedISMPTests & vbTab & vbTab & OpenISMPTests & _
                    vbCrLf & "ACC(s)" & vbTab & vbTab & vbTab & StartedACCS & vbTab & vbTab & ClosedACCS & vbTab & vbTab & OpenACCS & _
                    vbCrLf & Line & vbCrLf & _
                    "Total(s)" & vbTab & vbTab & vbTab & StartedTotal & vbTab & vbTab & ClosedTotal & vbTab & vbTab & OpenTotal & _
        ...
        Try
            ...
            If cboComplianceUnits.Items.Contains(cboComplianceUnits.Text) Then
                ...
                Select Case cboComplianceUnits.Text
                    Case "Administrative"
                        drEngineers = dtEngineers.Select("strUserDesc = 'Administrative'", "UserName")
                        For Each row In drEngineers
                            clbEngineers.Items.Add(row("UserName"))
                        Next
                    Case "Air Toxics"
                        drEngineers = dtEngineers.Select("strUserDesc = 'Air Toxics'", "UserName")
                        For Each row In drEngineers
                            clbEngineers.Items.Add(row("UserName"))
                        Next
                    Case "Chemicals/Mineral"
                        drEngineers = dtEngineers.Select("strUserDesc = 'Chemicals/Mineral'", "UserName")
                        For Each row In drEngineers
                            clbEngineers.Items.Add(row("UserName"))
                        Next
                    Case "VOC/Combustion"
                        drEngineers = dtEngineers.Select("strUserDesc = 'VOC/Combustion'", "UserName")
                        For Each row In drEngineers
                            clbEngineers.Items.Add(row("UserName"))
                        Next
                    Case "All Units"
                        drEngineers = dtEngineers.Select("", "UserName")
                        For Each row In drEngineers
                            clbEngineers.Items.Add(row("UserName"))
                        Next
                    Case "District"
