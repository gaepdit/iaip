...
#End Region
    ...
    Private Sub HelpToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HelpToolStripMenuItem.Click
        Try
            Help.ShowHelp(Label112, "http://airpermit.dnr.state.ga.us/helpdocs/IAIP_help/")
        Catch ex As Exception
            ErrorReport(ex.ToString(), Me.Name & "." & System.Reflection.MethodBase.GetCurrentMethod.Name)
        End Try
    ...
    Private Sub btnEISummary_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEISummary.Click
        Try
            If cboEIYear.Text <> "" And cboEIYear.Items.Contains(cboEIYear.Text) And cboEIYear.SelectedIndex <> 0 Then
                ...
                dgvEIResults.Columns("SO2").HeaderText = "SO2"
                dgvEIResults.Columns("SO2").DisplayIndex = 3
                dgvEIResults.Columns("NOX").HeaderText = "NOx"
                dgvEIResults.Columns("NOX").DisplayIndex = 4
                dgvEIResults.Columns("PMPRI").HeaderText = "PM Primary"
                dgvEIResults.Columns("PMPRI").DisplayIndex = 5
                dgvEIResults.Columns("PMFIL").HeaderText = "PM Filterable"
                dgvEIResults.Columns("PMFIL").DisplayIndex = 6
                dgvEIResults.Columns("PM10PRI").HeaderText = "PM 10 Primary"
                dgvEIResults.Columns("PM10PRI").DisplayIndex = 7
                dgvEIResults.Columns("PM25PRI").HeaderText = "PM 2.5 Primary"
                dgvEIResults.Columns("PM25PRI").DisplayIndex = 8
                dgvEIResults.Columns("VOC").HeaderText = "VOC"
                dgvEIResults.Columns("VOC").DisplayIndex = 9
                dgvEIResults.Columns("CO").HeaderText = "CO"
                dgvEIResults.Columns("CO").DisplayIndex = 10
                dgvEIResults.Columns("NH3").HeaderText = "Ammonia "
                dgvEIResults.Columns("NH3").DisplayIndex = 11
                dgvEIResults.Columns("Lead").HeaderText = "Lead"
                dgvEIResults.Columns("Lead").DisplayIndex = 12
            End If
