            ...
            Else
                ...
                Else
                    If AccountArray(4, 4) = "1" Then 'Distirct Liason (Special)
                        ...
                        chbSavannah.Checked = True
                        chbEastCentral.Checked = True
                        chbNortheast.Checked = True
                        chbSouthwest.Checked = True
                        chbWestCentral.Checked = True
                    Else
...
#Region "Subs and Functions"
    Sub LoaddgvWork()
        ...
        Try
            ...
            If chbAdministrative.Checked = False And chbAIRToxics.Checked = False _
                 And chbChemicalsMineral.Checked = False And chbVOCCombustion.Checked = False _
                    And chbAtlanta.Checked = False And chbCartersville.Checked = False _
                       And chbBrunswick.Checked = False And chbSavannah.Checked = False _
                          And chbEastCentral.Checked = False And chbNortheast.Checked = False _
                             And chbSouthwest.Checked = False And chbWestCentral.Checked = False Then
                ...
                End If
            Else
                If chbAdministrative.Checked = True Then
                    ...
                    dr.Close()
                End If
                If chbAIRToxics.Checked = True Then
                    SubSQL = "Select numUserID " & _
                    "from " & connNameSpace & ".EPDUserProfiles " & _
                    "where numUnit = '30' "
                    cmd = New OracleCommand(SubSQL, conn)
                    ...
                    dr.Close()
                End If
                If chbChemicalsMineral.Checked = True Then
                    SubSQL = "Select numUserID " & _
                    "from " & connNameSpace & ".EPDUserProfiles " & _
                    "where numUnit = '31' "
                    cmd = New OracleCommand(SubSQL, conn)
                    ...
                    dr.Close()
                End If
                If chbVOCCombustion.Checked = True Then
                    SubSQL = "Select numUserID " & _
                    "from " & connNameSpace & ".EPDUserProfiles " & _
                    "where numUnit = '32' "
                    cmd = New OracleCommand(SubSQL, conn)
                ...
                If chbAtlanta.Checked = True Then
                    SQLLine = SQLLine & " numUserID = '150' or "
                End If
                If chbCartersville.Checked = True Then
                    SQLLine = SQLLine & " numUserID = '263' or "
                End If
                If chbBrunswick.Checked = True Then
                    SQLLine = SQLLine & " numUserID = '193' or "
                End If
                If chbSavannah.Checked = True Then
                    SQLLine = SQLLine & " numUserID = '264' or "
                End If
                If chbEastCentral.Checked = True Then
                    SQLLine = SQLLine & " numUserID = '205' or "
                End If
                If chbNortheast.Checked = True Then
                    SQLLine = SQLLine & " numUserID = '203' or "
                End If
                If chbSouthwest.Checked = True Then
                    SQLLine = SQLLine & " numUserID = '192' or "
                End If
                If chbWestCentral.Checked = True Then
                    SQLLine = SQLLine & " numUserID = '188' or "
                End If

                If Me.chbEngineer.Checked = True Then
                    SQLLine = SQLLine & " numUserID = '" & UserGCode & "' Or "
                Else
                    Dim GCode As String = ""
                    For x As Integer = 0 To clbEngineer.Items.Count - 1
                        If clbEngineer.GetItemChecked(x) = True Then
            ...
            dgvWork.Columns("strNotificationType").HeaderText = "Notificaiton Type"
    ...
    Private Sub cboEvent_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboEvent.Leave
        ...
        Try
            ...
            If cboEvent.Text <> "" Then
                ...
                Else
                    lblDateField.Text = "Received by APB:"
                End If
            Else
                LabEventDescription.Visible = False
            End If
...
#End Region
    ...
    Private Sub chbNotifications_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chbNotifications.CheckedChanged
        Try
            If chbNotifications.Checked = True Then
                GBNotifications.Visible = True
                GBWorkTypes.Size = New System.Drawing.Size(208, 310)
             
            Else
                GBNotifications.Visible = False
    ...
    Private Sub btnCloseWorkType_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCloseWorkType.Click
        Try
            GBWorkTypes.Size = New System.Drawing.Size(208, 168)
        Catch ex As Exception
            ErrorReport(ex.ToString(), Me.Name & "." & System.Reflection.MethodBase.GetCurrentMethod.Name)
