        ...
        Try
            If AccountArray(66, 2) = "1" Or AccountArray(66, 3) = "1" Then
                ...
                Else
                    ...
                    If temp <> "" Then
                        result = MessageBox.Show("There is currently a Test Notification (" & temp & ") that is close to the date of this test notification." & vbCrLf & _
    ...
    Private Sub bbtSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bbtSave.Click
        Try
            If txtTestNotificationNumber.Text <> "" Then
                SaveNotification()
            Else
                MsgBox("First Select New Test Notificaiton.", MsgBoxStyle.Exclamation, "Notification Log")
            End If
