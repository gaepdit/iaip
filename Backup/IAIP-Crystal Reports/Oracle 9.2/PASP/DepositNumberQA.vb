...
Public Class DepositNumberQA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.DepositNumberQA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDepositNumberQA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DepositNumberQA = New DepositNumberQA
        rpt.Site = Me.Site
        Return rpt
    End Function
