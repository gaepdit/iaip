...
Public Class CRWebContacts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.CRWebContacts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRWebContacts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRWebContacts = New CRWebContacts
        rpt.Site = Me.Site
        Return rpt
    End Function
