...
Public Class CRInventoryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.CRInventoryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRInventoryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRInventoryReport = New CRInventoryReport
        rpt.Site = Me.Site
        Return rpt
    End Function
