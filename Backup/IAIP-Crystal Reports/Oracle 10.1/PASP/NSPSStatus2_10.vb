...
Public Class NSPSStatus2_10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.NSPSStatus2_10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNSPSStatus2_10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NSPSStatus2_10 = New NSPSStatus2_10
        rpt.Site = Me.Site
        Return rpt
    End Function
