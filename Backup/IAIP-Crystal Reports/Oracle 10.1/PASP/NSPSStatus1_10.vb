...
Public Class NSPSStatus1_10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.NSPSStatus1_10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNSPSStatus1_10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NSPSStatus1_10 = New NSPSStatus1_10
        rpt.Site = Me.Site
        Return rpt
    End Function
