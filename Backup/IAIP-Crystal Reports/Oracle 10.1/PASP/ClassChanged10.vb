...
Public Class ClassChanged10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.ClassChanged10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedClassChanged10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ClassChanged10 = New ClassChanged10
        rpt.Site = Me.Site
        Return rpt
    End Function
