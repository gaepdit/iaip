...
#Region "Subs and Functions"
    ...
    Sub LoadFeeRates(ByVal ActiveStatus As String)
        Try
            ...
            dgvFeeRates.Columns("datFeeDueDate").DisplayIndex = 8
            ...
            dgvFeeRates.Columns("numAdminFeeRate").DisplayIndex = 9
            ...
            dgvFeeRates.Columns("datAdminApplicable").DisplayIndex = 10
            ...
            dgvFeeRates.Columns("datFirstQrtDue").DisplayIndex = 11
            ...
            dgvFeeRates.Columns("datSecondQrtDue").DisplayIndex = 12
            ...
            dgvFeeRates.Columns("datThirdQrtDue").DisplayIndex = 13
            ...
            dgvFeeRates.Columns("datFourthQrtDue").DisplayIndex = 14
            ...
            dgvFeeRates.Columns("strComments").DisplayIndex = 15
...
#End Region
    ...
    Private Sub btnsaveRate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsaveRate.Click
        Try
            If Insert_FS_FeeRate(txtFeeYear.Text, dtpFeePeriodStart.Text, dtpFeePeriodEnd.Text, _
                               ...
                               dtpThirdQrtDue.Text, dtpFourthQrtDue.Text) = True Then
 ...
 '"and (strEnrolled = '1' or strInitialMailout = '1' or strMailoutSent = '1')  " & _
            ...
            dgvFeeManagmentLists.Columns("strFacilityName").HeaderText = "Facility Name"
            dgvFeeManagmentLists.Columns("strFacilityName").DisplayIndex = 1
            dgvFeeManagmentLists.Columns("strFacilityStreet1").HeaderText = "Facility Street"
