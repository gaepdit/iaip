        ...
        Try
            ...
            If rdbTitleVPermit.Checked = True Then
                If chbTVNarrative.Checked = True Then    'Prefix VN-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("VN-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbTVDraft.Checked = True Then         'Prefix VD-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("VD-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbTVPublicNotice.Checked = True Then   'Prefix VP-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("VP-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbTVFinal.Checked = True Then          'Prefix VF-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("VF-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
            End If
            If rdbPSDPermit.Checked = True Then
                If chbPSDApplicationSummary.Checked = True Then 'Prefix PA-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("PA-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbPSDPrelimDet.Checked = True Then          'Prefix PP-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("PP-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbPSDNarrative.Checked = True Then          'Prefix PT-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("PT-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbPSDDraftPermit.Checked = True Then        'Prefix PD-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("PD-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbPSDPublicNotice.Checked = True Then       'Prefix PN-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("PN-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbPSDHearingNotice.Checked = True Then      'Prefix PH-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("PH-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbPSDFinalDet.Checked = True Then           'Prefix PF- 
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("PF-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbPSDFinalPermit.Checked = True Then        'Prefix PI-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("PI-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
            End If
            If rdbOtherPermit.Checked = True Then
                If chbOtherNarrative.Checked = True Then       'Prefix ON-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("ON-" & MasterApp, doc, pdf, docOnFile)
                    End If
                End If
                If chbOtherPermit.Checked = True Then             'Prefix OP-
                    ...
                    End If
                    If doc <> "" Or pdf <> "" Then
                        UploadFile("OP-" & MasterApp, doc, pdf, docOnFile)
