    ...
    Sub GenerateSQL2()
        Try
            ...
            If chbSSCPEngineer.Checked = True Then
                ...
                If SQLFrom.IndexOf("" & connNameSpace & ".SSCPFacilityAssignment") <> -1 Then
                    SQLFrom = SQLFrom
                Else
                    SQLFrom = SQLFrom & " " & connNameSpace & ".SSCPFacilityAssignment, "
                    SQLWhere = SQLWhere & " and " & connNameSpace & ".APBMasterAIRS.strAIRSnumber = " & connNameSpace & ".SSCPFacilityAssignment.strAIRSNumber "
                End If
                If SQLFrom.IndexOf("" & connNameSpace & ".EPDUserProflies") <> -1 Then
                    SQLFrom = SQLFrom
                Else
                    SQLFrom = SQLFrom & " " & connNameSpace & ".EPDUserProfiles, "
                    SQLWhere = SQLWhere & " and " & connNameSpace & ".EPDUserProfiles.numUserID = " & connNameSpace & ".SSCPFacilityAssignment.strSSCPEngineer "
                End If
            End If
            ...
            If chbSSCPUnit.Checked = True Then
                ...
                Else
                    ...
                    SQLWhere = SQLWhere & " and " & connNameSpace & ".SSCPFacilityAssignment.strSSCPUnit = " & connNameSpace & ".LookUpEPDUnits.nuMUnitCode (+) "
                End If
            End If
            ...
            If chbSSCPEngineer.Checked = True Then
                ...
                If cboSSCPEngineerSearch1.SelectedIndex <> -1 And cboSSCPEngineerSearch1.SelectedIndex <> 0 Then
                    SQLWhere = SQLWhere & " and (" & connNameSpace & ".SSCPFacilityAssignment.strSSCPEngineer " & SQLWhereCase2 & " '" & cboSSCPEngineerSearch1.SelectedValue & "') "
                End If
                If cboSSCPEngineerSearch2.SelectedIndex <> -1 And cboSSCPEngineerSearch2.SelectedIndex <> 0 Then
                    If cboSSCPEngineerSearch1.SelectedIndex <> -1 And cboSSCPEngineerSearch1.SelectedIndex <> 0 Then
                        SQLWhere = Mid(SQLWhere, 1, (SQLWhere.Length - 2)) & _
                        " " & SQLWhereCase1 & " " & connNameSpace & ".SSCPFacilityAssignment.strSSCPEngineer " & SQLWhereCase2 & " '" & cboSSCPEngineerSearch2.SelectedValue & "' ) "
                    Else
                        SQLWhere = SQLWhere & " and (" & connNameSpace & ".SSCPFacilityAssignment.strSSCPEngineer " & SQLWhereCase2 & " '" & cboSSCPEngineerSearch2.SelectedValue & "') "
                    End If
                End If
            End If
            ...
            End If
            If chbShutDownDate.Checked = True Then
                dgvQueryGenerator.Columns("datShutDownDate").HeaderText = "Shut Down Date"
