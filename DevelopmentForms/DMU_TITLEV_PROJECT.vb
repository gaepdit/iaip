        ...
        Try
            ...
            While GATVdr.Read
                ...
                If temp = "Yes" Then
                    ...
                    'TVApplicaiton
                    cmd = New OracleCommand(SQL, connTVApplicaiton)
                    If connTVApplicaiton.State = ConnectionState.Closed Then
                        connTVApplicaiton.Open()
                    End If
                    dr = cmd.ExecuteReader
                    count += 1
                    dr.Close()
            ...
            While GATVdr.Read
                ...
                If ProjectId <> "" Then
                    ...
                    If GSID <> "" Then
                        ...
                        cmd2 = New OracleCommand(SQL, connTVApplicaiton)
                        If connTVApplicaiton.State = ConnectionState.Closed Then
                            connTVApplicaiton.Open()
                        End If
        ...
        Try
            ...
            While dr.Read
                ...
                If SIC <> "" Then
                    ...
                    cmd2 = New OracleCommand(SQL2, connTVApplicaiton)
                    If connTVApplicaiton.State = ConnectionState.Closed Then
                        connTVApplicaiton.Open()
                    End If
                    dr2 = cmd2.ExecuteReader
