...
<Assembly: CodeAnalysis.SuppressMessage("Security", "CA3075:Insecure DTD processing in XML", Justification:="Code auto-generated by Crystal Reports tool.", Scope:="member", Target:="~M:Iaip.CrDataSet.#ctor(System.Runtime.Serialization.SerializationInfo,System.Runtime.Serialization.StreamingContext)")>
<Assembly: CodeAnalysis.SuppressMessage("Security", "CA3075:Insecure DTD processing in XML", Justification:="Code auto-generated by Crystal Reports tool.", Scope:="member", Target:="~M:Iaip.CrDataSet.GetSchemaSerializable~System.Xml.Schema.XmlSchema")>
<Assembly: CodeAnalysis.SuppressMessage("Globalization", "CA1305:Specify IFormatProvider", Justification:="Too many throughout code to fix")>