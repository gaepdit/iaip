    ...
    Private Sub LoadFSData()
        Try
            ...
            SQL = "SELECT fi.STRFACILITYNAME, fi.STRFACILITYSTREET1, " &
                ...
                "  fi.STRFACILITYZIPCODE, CAST(fi.NUMFACILITYLONGITUDE AS decimal(9, 6)) AS NUMFACILITYLONGITUDE, " &
                "  CAST(fi.NUMFACILITYLATITUDE AS decimal(8, 6)) AS NUMFACILITYLATITUDE, hd.STROPERATIONALSTATUS " &
