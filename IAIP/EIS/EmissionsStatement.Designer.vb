...
Partial Class EmissionsStatement
    Inherits BaseForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.dgvESDataCount = New Iaip.IaipDataGridView()
        ...
        Me.Panel5.Size = New System.Drawing.Size(556, 713)
        ...
        Me.TabControl3.Size = New System.Drawing.Size(556, 665)
        ...
        Me.tabSummary.Size = New System.Drawing.Size(548, 639)
        ...
        Me.Label93.Size = New System.Drawing.Size(254, 22)
        Me.Label93.TabIndex = 0
        Me.Label93.Text = "Emission Statement Summary"
        '
        'tabMailOut
        '
        ...
        Me.tabMailOut.Size = New System.Drawing.Size(548, 639)
        ...
        Me.lblViewESMailOut.Size = New System.Drawing.Size(98, 13)
        Me.lblViewESMailOut.TabIndex = 0
        Me.lblViewESMailOut.TabStop = True
        Me.lblViewESMailOut.Text = "View All ES Mailout"
        '
        'txtcontactAddress1
        '
        ...
        Me.TabDetails.Size = New System.Drawing.Size(548, 639)
        ...
        Me.PnlESYear.Size = New System.Drawing.Size(556, 48)
        ...
        Me.cboYear.Font = New System.Drawing.Font("Microsoft Sans Serif", 10.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.cboYear.FormattingEnabled = True
        Me.cboYear.Location = New System.Drawing.Point(115, 12)
        Me.cboYear.Name = "cboYear"
        Me.cboYear.Size = New System.Drawing.Size(97, 24)
        ...
        Me.Panel2.Size = New System.Drawing.Size(460, 713)
        ...
        Me.dgvESDataCount.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.DisplayedCells
        ...
        Me.dgvESDataCount.ResultsCountLabel = Me.lblRecordNumber
        Me.dgvESDataCount.ResultsCountLabelFormat = "Count: {0}"
        Me.dgvESDataCount.Size = New System.Drawing.Size(460, 665)
        Me.dgvESDataCount.StandardTab = True
        Me.dgvESDataCount.TabIndex = 1
        '
        'lblRecordNumber
        '
        Me.lblRecordNumber.AutoSize = True
        Me.lblRecordNumber.Location = New System.Drawing.Point(6, 17)
        Me.lblRecordNumber.Name = "lblRecordNumber"
        Me.lblRecordNumber.Size = New System.Drawing.Size(0, 13)
        ...
        Me.Panel4.Size = New System.Drawing.Size(460, 48)
        ...
        Me.Name = "EmissionsStatement"
        Me.Text = "Emissions Statement"
    ...
    Friend WithEvents lblviewextraNonresponse As LinkLabel
    Friend WithEvents txtESextranonresponder As TextBox
    Friend WithEvents Label197 As Label
    Friend WithEvents lblviewmailoutnonresponder As LinkLabel
    Friend WithEvents txtESmailoutNonResponder As TextBox
    Friend WithEvents Label196 As Label
    Friend WithEvents lblviewESremovedfacility As LinkLabel
    Friend WithEvents txtESremovedFacilities As TextBox
    Friend WithEvents Label195 As Label
    Friend WithEvents lblviewESextraresponder As LinkLabel
    Friend WithEvents txtESextraResponders As TextBox
    Friend WithEvents Label194 As Label
    Friend WithEvents lblViewMailOut As LinkLabel
    Friend WithEvents Label76 As Label
    Friend WithEvents txtResponseCount As TextBox
    Friend WithEvents lblViewTotalResponse As LinkLabel
    Friend WithEvents txtTotalResponse As TextBox
    Friend WithEvents Label77 As Label
    Friend WithEvents lblViewExtraOptOut As LinkLabel
    Friend WithEvents txtExtraOptout As TextBox
    Friend WithEvents Label78 As Label
    Friend WithEvents lblViewExtraOptIn As LinkLabel
    Friend WithEvents txtExtraOptin As TextBox
    Friend WithEvents Label79 As Label
    Friend WithEvents lblViewOptOut As LinkLabel
    Friend WithEvents txtMailOutOptOut As TextBox
    Friend WithEvents Label80 As Label
    Friend WithEvents lblViewOptIn As LinkLabel
    Friend WithEvents txtMailoutOptin As TextBox
    Friend WithEvents Label81 As Label
    Friend WithEvents Label82 As Label
    Friend WithEvents lblextraResponse As LinkLabel
    Friend WithEvents txtextraResponse As TextBox
    Friend WithEvents Label83 As Label
    Friend WithEvents lblViewNonResponse As LinkLabel
    Friend WithEvents lblViewOutofcompliance As LinkLabel
    Friend WithEvents lblViewINCompliance As LinkLabel
    Friend WithEvents lblViewTotalOptOut As LinkLabel
    Friend WithEvents lblViewTotalOptin As LinkLabel
    Friend WithEvents txtTotaloutofcompliance As TextBox
    Friend WithEvents Label84 As Label
    Friend WithEvents txtTotalincompliance As TextBox
    Friend WithEvents Label85 As Label
    Friend WithEvents txtNonResponseCount As TextBox
    Friend WithEvents Label86 As Label
    Friend WithEvents txtTotalOptOutCount As TextBox
    Friend WithEvents Label87 As Label
    Friend WithEvents txtTotalOptInCount As TextBox
    Friend WithEvents Label89 As Label
    Friend WithEvents txtESMailOutCount As TextBox
    Friend WithEvents Label92 As Label
    Friend WithEvents Label93 As Label
    Friend WithEvents tabMailOut As TabPage
    ...
    Friend WithEvents txtcontactAddress2 As TextBox
    Friend WithEvents Label105 As Label
    Friend WithEvents txtEScompanyName As TextBox
    Friend WithEvents Label106 As Label
    Friend WithEvents txtESLastName As TextBox
    Friend WithEvents Label107 As Label
    Friend WithEvents txtESFirstName As TextBox
    Friend WithEvents Label108 As Label
    Friend WithEvents txtESprefix As TextBox
    Friend WithEvents Label109 As Label
    Friend WithEvents txtESFacilityName As TextBox
    Friend WithEvents Label110 As Label
    Friend WithEvents txtESAIRSNo2 As TextBox
    Friend WithEvents Label111 As Label
    Friend WithEvents TabDetails As TabPage
    Friend WithEvents txtESAirsNo As TextBox
    Friend WithEvents Label112 As Label
    Friend WithEvents txtESContactLastName As TextBox
    Friend WithEvents Label113 As Label
    Friend WithEvents lblViewESData As LinkLabel
    Friend WithEvents txtFirstConfirmedDate As TextBox
    Friend WithEvents Label114 As Label
    Friend WithEvents txtNOXEmission As TextBox
    Friend WithEvents txtVOCEmission As TextBox
    Friend WithEvents Label115 As Label
    Friend WithEvents Label116 As Label
    Friend WithEvents Label117 As Label
    Friend WithEvents txtConfirmationNbr As TextBox
    Friend WithEvents txtConfirmationNumber As TextBox
    Friend WithEvents Label120 As Label
    Friend WithEvents Label121 As Label
    Friend WithEvents txtESEmail As TextBox
    ...
    Friend WithEvents txtESContactFirstName As TextBox
    ...
    Friend WithEvents txtHORIZONTALREFERENCECODE As TextBox
    Friend WithEvents txtFACILITYADDRESS As TextBox
    Friend WithEvents txtFACILITYCITY As TextBox
    Friend WithEvents txtFACILITYSTATE As TextBox
    Friend WithEvents txtFACILITYZIP As TextBox
    Friend WithEvents txtCOUNTY As TextBox
    Friend WithEvents txtXCOORDINATE As TextBox
    Friend WithEvents txtYCOORDINATE As TextBox
    Friend WithEvents txtHORIZONTALCOLLECTIONCODE As TextBox
    Friend WithEvents txtHORIZONTALACCURACYMEASURE As TextBox
