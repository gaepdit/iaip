...
Public Class SSPPPublicNoticesAndAdvisories
    ...
    Private Sub PreviewReport()
        ...
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("To comment, send written comments via email to Air-Permits.Comments@dnr.ga.gov (include \ldblquote Air permit application\rdblquote  in the subject line) ")
        rtfDocument.AppendLine("or by mail to Air Permit Manager, 4244 International Parkway, Suite 120, Atlanta, Georgia 30354.\par")
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("All comments received on or prior to close of business 4:30 PM on the deadline will be considered by the Division in making its final decision to issue the permit.\par")
        rtfDocument.AppendLine("\par")
        ...
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("All visits to EPD’s offices are by appointment only. To set an appointment, email ask.epd@dnr.ga.gov with ")
        ...
        rtfDocument.AppendLine("permit application may also be requested by contacting Steve Allison, steve.allison2@dnr.ga.gov.\par")
        rtfDocument.AppendLine("\par")
        ...
        rtfDocument.AppendLine("Permit proceedings are required to submit their comments in writing. To comment, send written comments via email to Air-Permits.Comments@dnr.ga.gov (include ")
        ...
        rtfDocument.AppendLine("comments will be accepted up until close of business the next working day.) All comments received on or prior to close of business 4:30 PM on the deadline will be considered by the Division in making ")
        ...
        rtfDocument.AppendLine("Rules for Air Quality Control or the Federal Rules which the individual making the request is concerned may not have been adequately incorporated.\par")
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("Issued (final) permits are available for public viewing at this link: {\ul https://permitsearch.gaepd.org/} \par")
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("For further information, email ask.epd@dnr.ga.gov or call (404) 363-7000.\par")
        ...
        ' SIP/SM Public Notices section header
        rtfDocument.AppendLine("\pard\qc{\b NOTICE OF DRAFT SYNTHETIC MINOR AND SIP OPERATING PERMITS AND PERMIT MODIFICATIONS}\par")
        rtfDocument.AppendLine("{\b GEORGIA ENVIRONMENTAL PROTECTION DIVISION}\par")
        rtfDocument.AppendLine("{\b AIR PROTECTION BRANCH}\par")
        rtfDocument.AppendLine("{\b 4244 INTERNATIONAL PARKWAY, SUITE 120, ATLANTA, GA 30354}\par")
        rtfDocument.AppendLine("\par")
        ...
        ' SIP/SM Public Notices section footer
        rtfDocument.AppendLine("\pard\qj{\b ADDITIONAL INFORMATION:} The draft permits and permit amendments and all information used to develop the draft permits and permit ")
        rtfDocument.AppendLine("amendments are available for review. This includes the application, all relevant supporting materials and all other materials available to the permitting ")
        rtfDocument.AppendLine("authority used in the permit review process. This information is available for review at the office of the Air Protection Branch, 4244 International Parkway, ")
        rtfDocument.AppendLine("Suite 120, Atlanta, Georgia 30354. ")
        ...
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("Comments must be received by no later than the deadline indicated for the particular facility. (Should the comment period end on a weekend or holiday, ")
        rtfDocument.AppendLine("comments will be accepted up until close of business the next working day.) All comments received on or prior to close of business 4:30 PM on the deadline will be ")
        rtfDocument.AppendLine("considered by the Division in making its final decision to issue the permit or permit amendment.\par")
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("Any comments requesting a public hearing must be made prior to the deadline and should specify, in as much detail as possible, the portion of the Georgia Rules for ")
        rtfDocument.AppendLine("Air Quality Control or the Federal Rules which the individual making the request is concerned may not have been adequately incorporated. A public hearing may be held ")
        rtfDocument.AppendLine("if the Director of the EPD finds that such a hearing would assist the EPD in a proper review of the facility's ability to comply with the Federal and State air quality ")
        rtfDocument.AppendLine("regulations.\par")
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("Issued (final) permits are available for public viewing at this link: {\ul https://permitsearch.gaepd.org/} \par")
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("For further information, email ask.epd@dnr.ga.gov or call (404) 363-7000.\par}")
