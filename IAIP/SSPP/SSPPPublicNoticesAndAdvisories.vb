...
Public Class SSPPPublicNoticesAndAdvisories
    ...
    Private Sub PreviewReport()
        ...
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("All visits to EPD’s offices are by appointment only. To set an appointment, email askepd@dnr.ga.gov with ")
        ...
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("Comments must be received by no later than the deadline indicated for the particular facility before close of business at 4:30 p.m. (Should the comment period end on a weekend or holiday, ")
