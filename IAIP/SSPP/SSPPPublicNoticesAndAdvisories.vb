...
Public Class SSPPPublicNoticesAndAdvisories
    ...
    Private Sub PreviewReport()
        ...
        rtfDocument.AppendLine("\par")
        rtfDocument.AppendLine("To comment, send written comments via email to epd.comments@dnr.ga.gov (include \ldblquote Air permit application\rdblquote  in the subject line) ")
        ...
        rtfDocument.AppendLine("Permit proceedings are required to submit their comments in writing. To comment, send written comments via email to epd.comments@dnr.ga.gov (include ")
