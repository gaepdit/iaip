...
#Region "Page Load Functions"
    ...
    Private Sub LoadInformationRequestHistory()
        ...
        InformationRequestHistoryLoaded = True
    End Sub
...
#Region " Application fees "
    ...
    Private Sub AdjustFeesUI()
        ...
        If Not UpdatingValues Then
            ...
            lklGenerateEmail.Visible = FeeChangesAllowed And chbFeeDataFinalized.Checked And TotalFeeAmount > 0 And Not dtpFacilityFeeNotified.Checked
    ...
    Private Sub SaveApplicationFees()
        ...
        If Not SaveApplicationFeesData(feesInfo) = 0 Then
            MessageBox.Show("There as an error saving the application fees.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Sub
