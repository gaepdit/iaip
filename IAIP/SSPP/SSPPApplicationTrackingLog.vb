...
#Region "Page Load Functions"
    ...
    Private Sub LoadPermissions()
        Try
            ...
            If Not (CurrentUser.HasRole(118) OrElse
                ...
                (AccountFormAccess(51, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(138, 0) Is Nothing) OrElse ' not used
                ...
                (AccountFormAccess(3, 2) = "1" AndAlso AccountFormAccess(3, 4) = "0")) Then ' 122, N'SSPP Engineer'
            ...
            End If
            If (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(3, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0") OrElse ' 28, N'SSPP Program Manager'
               (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0" AndAlso AccountFormAccess(3, 4) = "0") Then ' 121, N'SSPP Unit Manager'
                btnAddApplicationToList.BackColor = Color.LightGreen
            End If
            If (AccountFormAccess(51, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(138, 0) Is Nothing) OrElse ' not used
               (AccountFormAccess(3, 2) = "1" AndAlso AccountFormAccess(3, 4) = "0") Then ' 122, N'SSPP Engineer'
            ...
            'cboISMPStaff
            If (AccountFormAccess(3, 2) = "1" AndAlso AccountFormAccess(3, 4) = "0") OrElse ' 122, N'SSPP Engineer'
                (AccountFormAccess(48, 2) = "1" AndAlso AccountFormAccess(48, 3) = "0" AndAlso AccountFormAccess(48, 4) = "0") Then ' 112, N'RMP Specialist', 113, N'SSCP Engineer'
            ...
            End If
            If (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(3, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0") Then ' 28, N'SSPP Program Manager'
                cboPublicAdvisory.BackColor = Color.LightBlue
                lblPublicAdvisory.BackColor = Color.LightBlue
            End If
            If (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0" AndAlso AccountFormAccess(3, 4) = "0") Then ' 121, N'SSPP Unit Manager'
            ...
            'cboSSCPStaff 
            If (AccountFormAccess(3, 2) = "1" AndAlso AccountFormAccess(3, 4) = "0") OrElse ' 122, N'SSPP Engineer'
                AccountFormAccess(67, 2) = "1" Then ' 116, N'ISMP Engineer', 117, N'ISMP Specialist'
          ...
          (AccountFormAccess(3, 2) = "1" AndAlso AccountFormAccess(3, 4) = "0") Then ' 122, N'SSPP Engineer'
            ...
            If CurrentUser.HasRole(118) OrElse
                ...
                (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0" AndAlso AccountFormAccess(3, 4) = "0") OrElse ' 121, N'SSPP Unit Manager'
                (AccountFormAccess(51, 4) = "1" AndAlso AccountFormAccess(23, 3) = "1" AndAlso AccountFormAccess(138, 1) = "1") OrElse
                (AccountFormAccess(51, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(138, 0) Is Nothing) Then ' not used
            ...
            End If
            If (AccountFormAccess(3, 2) = "1" AndAlso AccountFormAccess(3, 4) = "0") Then ' 122, N'SSPP Engineer'
            ...
            End If
            If (AccountFormAccess(51, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(138, 0) Is Nothing) Then ' not used
    ...
    Private Shared Function UserCanAccessHistoryTab() As Boolean
        Return CurrentUser.HasRole(118) OrElse
                (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(3, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0") OrElse ' 28, N'SSPP Program Manager'
                (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0" AndAlso AccountFormAccess(3, 4) = "0") OrElse ' 121, N'SSPP Unit Manager'
                (AccountFormAccess(51, 4) = "1" AndAlso AccountFormAccess(23, 3) = "1" AndAlso AccountFormAccess(138, 1) = "1") OrElse
    ...
    Private Shared Function UserCanAccessInformationRequestTab() As Boolean
        Return CurrentUser.HasRole(118) OrElse
                 (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(3, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0") OrElse ' 28, N'SSPP Program Manager'
                 (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0" AndAlso AccountFormAccess(3, 4) = "0") OrElse ' 121, N'SSPP Unit Manager'
                 (AccountFormAccess(51, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(138, 0) Is Nothing) OrElse ' not used
    ...
    Private Shared Function UserCanAccessWebPublisherTab() As Boolean
        Return CurrentUser.HasRole(118) OrElse
                  (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(3, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0") OrElse ' 28, N'SSPP Program Manager'
                  (AccountFormAccess(51, 4) = "1" AndAlso AccountFormAccess(23, 3) = "1" AndAlso AccountFormAccess(138, 1) = "1") OrElse
    ...
    Private Shared Function UserCanAccessOtherInfoTab() As Boolean
        Return CurrentUser.HasRole(118) OrElse
               (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(3, 4) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0") OrElse ' 28, N'SSPP Program Manager'
               (AccountFormAccess(24, 3) = "1" AndAlso AccountFormAccess(12, 1) = "1" AndAlso AccountFormAccess(12, 2) = "0" AndAlso AccountFormAccess(3, 4) = "0") OrElse ' 121, N'SSPP Unit Manager'
               (AccountFormAccess(51, 4) = "1" AndAlso AccountFormAccess(23, 3) = "1" AndAlso AccountFormAccess(138, 1) = "1") OrElse
...
#End Region
    ...
    Private Sub LoadApplicationData()
        ...
        Try
            ...
            If dr IsNot Nothing Then
                ...
                EmailBatchId = GetNullable(Of Guid?)(dr.Item(NameOf(EmailBatchId)))
    ...
    Private Sub FindMasterApp()
        Const query As String = "select strMasterApplication " &
              "from SSPPApplicationLinking " &
              "where strApplicationNumber = @appnumber "

        MasterApp = DB.GetString(query, _appNumberSqlParam)
        If String.IsNullOrEmpty(MasterApp) Then MasterApp = AppNumber.ToString
    End Sub
    ...
    Private Sub LinkPermitNumber()
        ...
        If DB.GetBoolean(query, parameter) Then
    ...
    Private Sub LoadDocumentsTab()
        Const query As String = "select p.STRFILENAME as [File Name],
                   case
                       when left(p.STRFILENAME, 2) = 'VN' then 'Title V Permit Narrative'
                       when left(p.STRFILENAME, 2) = 'VD' then 'Title V Draft Permit'
                       when left(p.STRFILENAME, 2) = 'VP' then 'Title V Public Notice'
                       when left(p.STRFILENAME, 2) = 'VF' then 'Title V Final Permit'
                       when left(p.STRFILENAME, 2) = 'PA' then 'PSD Application Summary'
                       when left(p.STRFILENAME, 2) = 'PP' then 'PSD Preliminary Determination'
                       when left(p.STRFILENAME, 2) = 'PT' then 'PSD Narrative'
                       when left(p.STRFILENAME, 2) = 'PD' then 'PSD Draft Permit'
                       when left(p.STRFILENAME, 2) = 'PN' then 'PSD Public Notice'
                       when left(p.STRFILENAME, 2) = 'PH' then 'PSD Hearing Notice'
                       when left(p.STRFILENAME, 2) = 'PF' then 'PSD Final Determination'
                       when left(p.STRFILENAME, 2) = 'PI' then 'PSD Final Permit'
                       when left(p.STRFILENAME, 2) = 'ON' then 'SIP Permit Narrative'
                       when left(p.STRFILENAME, 2) = 'OP' then 'SIP Final Permit'
                       else 'ERROR'
                       end as [Document Type],
                   concat_ws(', ', u.STRLASTNAME, u.STRFIRSTNAME) as [Uploaded By],
                   convert(date, p.DATPDFMODIFINGDATE) as [Date Uploaded]
            from APBPERMITS p
                left join EPDUSERPROFILES u
                    on p.STRPDFMODIFINGPERSON = u.NUMUSERID
            where p.STRFILENAME like '%-' + @MasterApp
            order by p.DATPDFMODIFINGDATE"
        Dim parameter As New SqlParameter("@MasterApp", MasterApp)

        Dim dr As DataTable = DB.GetDataTable(query, parameter)

        If dr Is Nothing OrElse dr.Rows.Count = 0 Then
            dgvDocumentsTable.Visible = False
            lblNoDocuments.Visible = True
            dgvDocumentsTable.DataSource = Nothing
        Else
            dgvDocumentsTable.Visible = True
            lblNoDocuments.Visible = False
            dgvDocumentsTable.DataSource = dr
        End If
    End Sub

    Private Sub dgvDocumentsTable_CellLinkActivated(sender As Object, e As IaipDataGridViewCellLinkEventArgs) Handles dgvDocumentsTable.CellLinkActivated
        Dim filename As String = e.LinkValue.ToString
    ...
    Private Sub llbPermitNumber_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles llbPermitNumber.LinkClicked
        ...
        If filename IsNot Nothing Then OpenPermitFileLink(filename, Me)
    End Sub
...
#Region " Email functions "
    ...
    Private Async Sub LoadEmailBatchDetails()
        ...
        If EmailBatchId Is Nothing Then
            ...
            lblNoEmailsSentLabel.Visible = True
            dgvEmailsSent.Visible = False
            TCApplicationTrackingLog.Controls.Remove(TPEmails)
        Else
            ...
            Else
                ...
                lblNoEmailsSentLabel.Visible = False
    ...
    Private Sub UpdateEmailBatchId()
...
#Region " Application Acknowledgement Email "
    ...
    Private Async Sub btnEmailAcknowledgmentLetter_Click(sender As Object, e As EventArgs) Handles btnEmailAcknowledgmentLetter.Click
        ...
        body.AppendLine().AppendLine()
        body.Append("GEOS, the web-based permit application system is located at: ")
        ...
        body.Append($"or via e-mail at {CurrentUser.EmailAddress}. Any written correspondence should reference the above application ")
...
#Region " Fee Notification email "
    ...
    Private Sub lklRecipientLink_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lklRecipientLink.LinkClicked
        TCApplicationTrackingLog.SelectedTab = TPContactInformation
        txtContactEmailAddress.Focus()
    End Sub

    Private Sub txtContactEmailAddress_TextChanged(sender As Object, e As EventArgs) Handles txtContactEmailAddress.TextChanged
        lklRecipientLink.Text = $"Recipient: {txtContactEmailAddress.Text.Trim()} (update)"
        lklRecipientLink.LinkArea = New LinkArea(lklRecipientLink.Text.Length - 8, 8)
    End Sub
    ...
    Private Async Sub btnGenerateFeeNotification_Click(sender As Object, e As EventArgs) Handles btnGenerateFeeNotification.Click
        ...
        body.AppendLine().AppendLine()
        body.Append("FEE PAYMENT INSTRUCTIONS: Do not send payment to the Air Branch office address; pay by check to the PO Box ")
