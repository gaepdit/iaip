' Details: https://www.programmingnotes.org/6229/vb-net-how-to-send-post-process-a-rest-api-web-request-using-vb-net/
...
Namespace ApiCalls.WebRequest
    Friend Module modRequest
        ''' <summary>
    ...
    Friend MustInherit Class ContentType
