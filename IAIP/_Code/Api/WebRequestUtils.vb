    ...
    Namespace WebRequest
        Public Module modRequest
            ...
            Public Async Function ExecuteAsync(type As Method _
                                    ...
                                    , Optional options As Options = Nothing) As Task(Of Response)
                Dim request As Net.HttpWebRequest = CType(System.Net.WebRequest.Create(url), System.Net.HttpWebRequest)
                ...
                If payload IsNot Nothing Then
                    ...
                    Using requestStream As Stream = request.GetRequestStream
                        Using payloadStream As MemoryStream = New System.IO.MemoryStream(payload)
            ...
            Private Sub CopyProperties(Of T1, T2)(dest As T1, src As T2)
                Dim srcProps As Reflection.PropertyInfo() = src.GetType().GetProperties()
                Dim destProps As Reflection.PropertyInfo() = dest.GetType().GetProperties()
                For Each srcProp As Reflection.PropertyInfo In srcProps
