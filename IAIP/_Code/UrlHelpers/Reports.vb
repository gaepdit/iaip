...
Namespace UrlHelpers
    ...
    Public Module Reports
        ...
        Public Sub OpenAccUrl(facilityId As ApbFacilityId, year As Integer, Optional objectSender As Form = Nothing)
            Dim url As Uri = GetAccUrl(facilityId, year)
            DAL.LogReportUsage("acc", url.ToString)
            OpenUrl(url, objectSender)
        End Sub
        ...
        Public Sub OpenFceUrl(facilityId As ApbFacilityId, id As Integer, Optional objectSender As Form = Nothing)
        ...
        Public Sub OpenStackTestUrl(facilityId As ApbFacilityId, referenceNumber As Integer, Optional objectSender As Form = Nothing)
