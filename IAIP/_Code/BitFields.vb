Module BitFields
    ...
    Private Function ConvertBitFieldToInteger(bitField As String, Optional reversed As Boolean = True) As Integer
    ...
    Private Function ConvertIntegerToEnum(Of TEnum)(i As Integer) As TEnum
    ...
    Private Function ConvertIntegerToBitFlags(i As Integer, totalWidth As Integer, Optional reverse As Boolean = True) As String
