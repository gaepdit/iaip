...
Public Class crESDataViewer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Iaip.crESDataViewer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrESDataViewer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crESDataViewer = New crESDataViewer
        rpt.Site = Me.Site
        Return rpt
    End Function
