...
Public Class CRTitleVRenewal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.CRTitleVRenewal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRTitleVRenewal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRTitleVRenewal = New CRTitleVRenewal
        rpt.Site = Me.Site
        Return rpt
    End Function
