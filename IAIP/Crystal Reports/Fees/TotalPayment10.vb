...
Public Class TotalPayment10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Iaip.TotalPayment10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTotalPayment10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TotalPayment10 = New TotalPayment10()
        rpt.Site = Me.Site
        Return rpt
    End Function
