...
Public Class FeesByAirs10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.FeesByAirs10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFeesByAirs10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FeesByAirs10 = New FeesByAirs10()
        rpt.Site = Me.Site
        Return rpt
    End Function
