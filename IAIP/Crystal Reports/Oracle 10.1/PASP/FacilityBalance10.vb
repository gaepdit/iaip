...
Public Class FacilityBalance10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.FacilityBalance10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacilityBalance10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacilityBalance10 = New FacilityBalance10
        rpt.Site = Me.Site
        Return rpt
    End Function
