...
Public Class SSPPPublicNotice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.SSPPPublicNotice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PublicNotice() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSSPPPublicNotice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSPPPublicNotice = New SSPPPublicNotice()
        rpt.Site = Me.Site
        Return rpt
    End Function
