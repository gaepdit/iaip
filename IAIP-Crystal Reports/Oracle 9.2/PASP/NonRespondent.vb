...
Public Class NonRespondent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.NonRespondent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNonRespondent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NonRespondent = New NonRespondent()
        rpt.Site = Me.Site
        Return rpt
    End Function
