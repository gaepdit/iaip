...
Public Class FacilityComments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.FacilityComments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacilityComments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacilityComments = New FacilityComments()
        rpt.Site = Me.Site
        Return rpt
    End Function
