...
Public Class FacilityFeeDraft
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.FacilityFeeDraft.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AirsNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFacilityFeeDraft
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacilityFeeDraft = New FacilityFeeDraft()
        rpt.Site = Me.Site
        Return rpt
    End Function
