...
Public Class CRMemorandumPTE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.CRMemorandumPTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Memorandum() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRMemorandumPTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRMemorandumPTE = New CRMemorandumPTE
        rpt.Site = Me.Site
        Return rpt
    End Function
