...
Public Class crPassFailNoShow
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.crPassFailNoShow.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPassFailNoShow
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPassFailNoShow = New crPassFailNoShow
        rpt.Site = Me.Site
        Return rpt
    End Function
