...
Public Class DepositQA11
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.DepositQA11.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SearchType() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDepositQA11
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DepositQA11 = New DepositQA11
        rpt.Site = Me.Site
        Return rpt
    End Function
