...
Public Class CRAirProgramCodes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.CRAirProgramCodes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRAirProgramCodes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRAirProgramCodes = New CRAirProgramCodes
        rpt.Site = Me.Site
        Return rpt
    End Function
