...
Public Class CREnforcement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.CREnforcement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCREnforcement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CREnforcement = New CREnforcement
        rpt.Site = Me.Site
        Return rpt
    End Function
