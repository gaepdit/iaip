...
Public Class crFeeInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.crFeeInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrFeeInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crFeeInvoice = New crFeeInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
