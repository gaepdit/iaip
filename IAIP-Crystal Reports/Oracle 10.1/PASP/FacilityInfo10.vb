...
Public Class FacilityInfo10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.FacilityInfo10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacilityInfo10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacilityInfo10 = New FacilityInfo10
        rpt.Site = Me.Site
        Return rpt
    End Function
