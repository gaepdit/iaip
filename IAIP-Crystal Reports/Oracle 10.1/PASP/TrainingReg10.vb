...
Public Class TrainingReg10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.TrainingReg10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTrainingReg10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TrainingReg10 = New TrainingReg10
        rpt.Site = Me.Site
        Return rpt
    End Function
