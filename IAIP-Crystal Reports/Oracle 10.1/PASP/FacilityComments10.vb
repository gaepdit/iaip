...
Public Class FacilityComments10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.FacilityComments10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacilityComments10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacilityComments10 = New FacilityComments10
        rpt.Site = Me.Site
        Return rpt
    End Function
