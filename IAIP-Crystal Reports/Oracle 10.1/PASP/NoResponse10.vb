...
Public Class NoResponse10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.NoResponse10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNoResponse10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NoResponse10 = New NoResponse10
        rpt.Site = Me.Site
        Return rpt
    End Function
