...
Public Class DepositDataQA10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.DepositDataQA10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDepositDataQA10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DepositDataQA10 = New DepositDataQA10()
        rpt.Site = Me.Site
        Return rpt
    End Function
