...
Public Class AuditReport10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.AuditReport10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAuditReport10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AuditReport10 = New AuditReport10
        rpt.Site = Me.Site
        Return rpt
    End Function
