...
Public Class NonRespondent10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.NonRespondent10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNonRespondent10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NonRespondent10 = New NonRespondent10
        rpt.Site = Me.Site
        Return rpt
    End Function
