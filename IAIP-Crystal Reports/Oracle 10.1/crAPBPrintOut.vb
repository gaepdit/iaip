...
Public Class crAPBPrintOut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JohnGaltProject.crAPBPrintOut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAPBPrintOut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAPBPrintOut = New crAPBPrintOut
        rpt.Site = Me.Site
        Return rpt
    End Function
